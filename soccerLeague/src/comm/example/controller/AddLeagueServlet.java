...
public class AddLeagueServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(!errMsgs.isEmpty())
		{
			...
			RequestDispatcher view=request.getRequestDispatcher("/AddLeagueView.view");
		...
		else
		{
			...
			List<League> li=(List<League>)request.getServletContext().getAttribute("leaguelist");
			li.add(new League(year, season,title));
